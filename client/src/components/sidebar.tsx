  ...
  return (
    <div className="relative flex">
      ...
      <Button
        ...
        className="absolute -right-4 top-6 z-10 h-6 w-8 bg-background border border-border rounded-full shadow-md hover:bg-muted transition-all duration-300 flex items-center justify-center"

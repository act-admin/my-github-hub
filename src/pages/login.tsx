...
export default function Login() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      // Simple demo authentication (replace with Supabase Auth for production)
      // For demo purposes, accept any valid email format with password "demo123"
